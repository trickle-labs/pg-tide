...
pgrx::extension_sql_file!(
    "../../sql/pg_tide--0.46.0--0.47.0.sql",
    name = "pg_tide_m_0_47",
    requires = ["pg_tide_m_0_46"]
);
pgrx::extension_sql_file!(
    "../../sql/pg_tide--0.47.0--0.48.0.sql",
    name = "pg_tide_m_0_48",
    requires = ["pg_tide_m_0_47"]
);
pgrx::extension_sql_file!(
    "../../sql/pg_tide--0.48.0--0.49.0.sql",
    name = "pg_tide_m_0_49",
    requires = ["pg_tide_m_0_48"]
);
pgrx::extension_sql_file!(
    "../../sql/pg_tide--0.49.0--0.50.0.sql",
    name = "pg_tide_m_0_50",
    requires = ["pg_tide_m_0_49"]
);
pgrx::extension_sql_file!(
    "../../sql/pg_tide--0.50.0--0.51.0.sql",
    name = "pg_tide_m_0_51",
    requires = ["pg_tide_m_0_50"]
);
pgrx::extension_sql_file!(
    "../../sql/pg_tide--0.51.0--0.52.0.sql",
    name = "pg_tide_m_0_52",
    requires = ["pg_tide_m_0_51"]
);
pgrx::extension_sql_file!(
    "../../sql/pg_tide--0.52.0--0.53.0.sql",
    name = "pg_tide_m_0_53",
    requires = ["pg_tide_m_0_52"]
);
pgrx::extension_sql_file!(
    "../../sql/pg_tide--0.53.0--0.54.0.sql",
    name = "pg_tide_m_0_54",
    requires = ["pg_tide_m_0_53"]
);
