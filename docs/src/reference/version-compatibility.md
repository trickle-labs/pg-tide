...
The v0.52.0 lifecycle policy is the machine-readable source of truth:
...
| 0.52.0 | 0.51.0 | rejected | `lifecycle-compatibility-pr` |
| <0.51.0 | 0.52.0 | rejected | `lifecycle-compatibility-pr` |
| >0.52.0 | 0.52.0 | rejected | `lifecycle-compatibility-pr` |
...
The v0.52.0 extension migration is transactional. If it fails before commit,
retry from the committed v0.51.0 state. After commit, restore a v0.51.0 backup
