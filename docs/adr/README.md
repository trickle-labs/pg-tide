...
| [ADR-006](adr-006-outbox-table-partitioning.md) | Outbox Table Partitioning | Superseded by ADR-013 |
| [ADR-007](adr-007-shared-partition-table-semantics.md) | Shared Partition Table Semantics | Superseded by ADR-013 |
...
| [ADR-014](adr-014-upgrade-rollback-and-recovery-contract.md) | Upgrade, Rollback, and Recovery Contract | Accepted |
